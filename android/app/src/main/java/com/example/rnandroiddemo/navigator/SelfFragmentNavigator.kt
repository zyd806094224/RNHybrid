package com.example.rnandroiddemo.navigator
...
/**
 * 自定义FragmentNavigator，使用hide/show代替replace，防止Fragment生命周期重走
 */
@Navigator.Name("selfFragment")
class SelfFragmentNavigator(
    context: Context,
    ...
    private val TAG = "SelfFragmentNavigator"
